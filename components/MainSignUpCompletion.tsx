               ...
               <section className={`hero is-light ${styles["full-height"]}`}>
                   <div id={styles.wrapper}>
                        <div id={styles.dialog}>
                            ...
                            <div id={styles.form}>
                                <input ref={(ref) => this.inputRefs[0] = ref} value={this.state.userCode0} onKeyUp={this.handleKeyUp(0)} onKeyDown={this.handleKeyDown} onChange={this.handleInputOnChange("userCode0")} type="text" maxLength={1} size={1} min={0} max={9} pattern="[0-9]{1}" />
                                <input ref={(ref) => this.inputRefs[1] = ref} value={this.state.userCode1} onKeyUp={this.handleKeyUp(1)} onKeyDown={this.handleKeyDown} onChange={this.handleInputOnChange("userCode1")} type="text" maxLength={1} size={1} min={0} max={9} pattern="[0-9]{1}" />
                                <input ref={(ref) => this.inputRefs[2] = ref} value={this.state.userCode2} onKeyUp={this.handleKeyUp(2)} onKeyDown={this.handleKeyDown} onChange={this.handleInputOnChange("userCode2")} type="text" maxLength={1} size={1} min={0} max={9} pattern="[0-9]{1}" />
                                <input ref={(ref) => this.inputRefs[3] = ref} value={this.state.userCode3} onKeyUp={this.handleKeyUp(3)} onKeyDown={this.handleKeyDown} onChange={this.handleInputOnChange("userCode3")} type="text" maxLength={1} size={1} min={0} max={9} pattern="[0-9]{1}" />
                                <input ref={(ref) => this.inputRefs[4] = ref} value={this.state.userCode4} onKeyUp={this.handleKeyUp(4)} onKeyDown={this.handleKeyDown} onChange={this.handleInputOnChange("userCode4")} type="text" maxLength={1} size={1} min={0} max={9} pattern="[0-9]{1}" />
                                <input ref={(ref) => this.inputRefs[5] = ref} value={this.state.userCode5} onKeyUp={this.handleKeyUp(5)} onKeyDown={this.handleKeyDown} onChange={this.handleInputOnChange("userCode5")} type="text" maxLength={1} size={1} min={0} max={9} pattern="[0-9]{1}" />
